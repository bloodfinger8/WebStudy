...
function checkWrite() { //유효성 검사 
		if (document.personForm.name.value == "") {
			alert("이름 입력하시오");
		}else if (document.personForm.id.value == "") {
			alert("아이디 입력하시오");
		}else if (document.personForm.pwd.value == "") {
			alert("비밀번호를 입력하시오");
		}else if (document.personForm.repwd.value == "") {
			alert("비밀번호 재확인을 입력하시오");
		}
		else if((document.personForm.pwd.value != document.personForm.repwd.value)){
			alert("비밀번호 불일치");
		}else 
